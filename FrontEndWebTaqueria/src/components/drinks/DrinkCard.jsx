    ...
    <div className="bg-white rounded-lg overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow flex flex-col justify-between">
      <div>
        <div className="relative">
          ...
          {isMostSold && (
            <div className="absolute top-3 left-3 bg-red-600 text-white px-2 sm:px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1 shadow-md">
          ...
          {!isAvailable && (
            <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center backdrop-blur-[1px]">
              <span className="text-white font-bold text-base sm:text-lg tracking-wide border-2 border-white px-4 py-1 rounded">
                SIN STOCK
              </span>
            </div>
          )}
        ...
        <div className="p-3 sm:p-4 pb-0">
          <h3 className="font-bold text-gray-900 text-sm sm:text-base mb-1 truncate">{title}</h3>
          <p className="text-red-600 font-extrabold text-lg sm:text-xl mb-2">
