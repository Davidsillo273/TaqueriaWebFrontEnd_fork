...
import FAIcon from '../commons/FAIcon' // El componente global de iconos

// Tarjetitas de arriba con números estadísticos para que no se vea vacío
const ClientKpis = () => {
  return (
      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm flex items-center justify-between">
        <div>
          ...
          <span className="text-xs text-green-600 font-semibold flex items-center gap-1 mt-2">
            <FAIcon icon="arrow-up" /> +4.2% este mes
          </span>
        </div>
