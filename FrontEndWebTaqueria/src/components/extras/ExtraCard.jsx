...
const ExtraCard = ({ title, price, status = 'DISPONIBLE', onEdit, onDelete }) => {
	const statusColor = status === 'DISPONIBLE' 
		? 'bg-green-500 text-white' 
		: 'bg-red-600 text-white'

	return (
		<div className="bg-white rounded-lg overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow flex flex-col justify-between p-5">
